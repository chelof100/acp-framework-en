...
% ACP v1.12 — Admission Control for Agent Actions
...
\title{%
  ...
  \large ACP v1.12: Admission Control for Agent Actions\\[0.3em]
...
The v1.12 specification comprises 36 technical documents organized into five conformance levels (L1--L5).
It includes a Go reference implementation of 22 packages covering all L1--L4 capabilities,
51 signed conformance test vectors (Ed25519 + SHA-256), and an OpenAPI 3.1.0 specification for all HTTP endpoints.
...
ACP v1.12 is a complete Draft Standard specification with a full Go reference implementation.

\subsection{Active Specifications --- v1.12 (36 documents)}
...
\bottomrule
\end{tabular}
\caption{ACP v1.12 active specification documents by conformance level.
...
\subsection{Conformance Test Vectors --- 51 Signed Vectors}

The \texttt{compliance/test-vectors/} directory contains 51 signed test vectors per ACP-TS-1.1:
...
\bottomrule
\end{tabular}
\caption{ACP v1.12 development roadmap.}
\end{table}
...
The v1.12 specification is complete.
A full Go reference implementation (22 packages, L1--L4) and 51 signed conformance test vectors
