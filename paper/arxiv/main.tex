...
We further characterize a bounded state-mixing vulnerability: agents executing
high-frequency benign operations in one context can inadvertently elevate risk
scores in unrelated high-value contexts due to partial state aggregation, a
property that stateless engines neither expose nor mitigate.
