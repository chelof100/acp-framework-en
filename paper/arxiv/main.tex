...
combining Ed25519 with ML-DSA-65 (Dilithium mode3) via the Cloudflare CIRCL library
...
Performance characteristics of ML-DSA-65 are not evaluated in this work;
inclusion demonstrates integration feasibility and implementation readiness.
...
(2)~\texttt{RedisQuerier} (Redis~7 sorted sets via \texttt{go-redis/v9},
...
Relative column is normalized to unpipelined Redis (1.7$\times$) and to InMemoryQuerier (1.0$\times$).}
\label{tab:adv-exp3}
\end{table}
