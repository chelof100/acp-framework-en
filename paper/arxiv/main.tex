...
% ACP v1.26 — Admission Control for Agent Actions
...
\title{%
  ...
  \large ACP v1.26: Admission Control for Agent Actions\\[0.3em]
...
\date{April 2026 \\ \small Draft Standard \\ \small \href{https://arxiv.org/abs/2603.18829}{arXiv:2603.18829 [cs.CR]} \quad \href{https://doi.org/10.5281/zenodo.19482968}{DOI: 10.5281/zenodo.19482968}}
...
ACP v1.26 is a complete Draft Standard specification with a full Go reference implementation
and external verifiability through a TLC-checked formal model and an ACR-1.0 sequence compliance runner.

\subsection{Active Specifications --- v1.26 (38 documents)}
...
\bottomrule
\end{tabular}
\caption{ACP v1.26 active specification documents by conformance level (38 primary documents shown).
...
All experiments use the Go reference implementation (v1.26) on an Intel Core i7-8665U @ 1.90GHz (Go~1.22~\cite{go-language}, \texttt{GOMAXPROCS=8}).
...
\bottomrule
\end{tabular}
\caption{ACP v1.26 development roadmap.}
\label{tab:roadmap}
\end{table}
...
Four findings emerge from this taxonomy:
...
\textbf{Preprint:} \url{https://arxiv.org/abs/2603.18829} \quad \textbf{Zenodo:} \href{https://doi.org/10.5281/zenodo.19482968}{10.5281/zenodo.19482968}\\
