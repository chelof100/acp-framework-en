...
% ACP v1.27 — Admission Control for Agent Actions
...
\hypersetup{
  ...
  pdfsubject={Formal protocol for governance of autonomous agents. v1.27. arXiv:2603.18829},
...
\title{%
  ...
  \large ACP v1.27: Admission Control for Agent Actions\\[0.3em]
...
\date{April 2026 \\ \small Draft Standard \\ \small \href{https://arxiv.org/abs/2603.18829}{arXiv:2603.18829 [cs.CR]} \quad \href{https://doi.org/10.5281/zenodo.19485201}{DOI: 10.5281/zenodo.19485201}}
...
Stateless policy engines (e.g., ABAC, RBAC, OPA~\cite{opa}) evaluate requests independently
...
Enforcing frequency-based or cooldown constraints in such systems requires externalizing
state to a separate store and threading it through every evaluation call,
increasing architectural complexity and weakening enforcement guarantees.
...
cannot enforce without external state integration.
...
ACP v1.27 is a complete Draft Standard specification with a full Go reference implementation
and external verifiability through a TLC-checked formal model and an ACR-1.0 sequence compliance runner.

\subsection{Active Specifications --- v1.27 (38 documents)}
...
\bottomrule
\end{tabular}
\caption{ACP v1.27 active specification documents by conformance level (38 primary documents shown).
...
All experiments use the Go reference implementation (v1.27) on an Intel Core i7-8665U @ 1.90GHz (Go~1.22~\cite{go-language}, \texttt{GOMAXPROCS=8}).
...
\emph{Scope.}
ACP v1.27 enforces guarantees at the per-agent level. Cross-agent coordination is
...
\bottomrule
\end{tabular}
\caption{ACP v1.27 development roadmap.}
\label{tab:roadmap}
\end{table}
...
\textbf{Preprint:} \url{https://arxiv.org/abs/2603.18829} \quad \textbf{Zenodo:} \href{https://doi.org/10.5281/zenodo.19485201}{10.5281/zenodo.19485201}\\
